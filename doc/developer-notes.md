...
master Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadSocketHandler : Sends/Receives data from peers on port 24127.
...
- ThreadRPCServer : Remote procedure call handler, listens on port 24126 for connections and services them.
...
However, in open source software such as master Core, where everyone uses
...
pay attention to for reviewers of master Core code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: master Core uses tinyformat, which is type safe. Leave them out to avoid confusion
