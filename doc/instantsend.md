...
This mechanism has been integrated into Bitcore-Node-master which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/masterpay/insight-api-master#web-socket-api](https://github.com/masterpay/insight-api-master#web-socket-api)
* API: [https://github.com/masterpay/insight-api-master#instantsend-transactions](https://github.com/masterpay/insight-api-master#instantsend-transactions)
...
By default, the master Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the master Core daemon:
