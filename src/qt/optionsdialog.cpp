    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("master-light"), QVariant("light"));
    ui->theme->addItem(QString("master-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("master-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("master-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("master-traditional"), QVariant("trad"));
