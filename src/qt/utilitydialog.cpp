    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("master Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About master Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  master-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the master in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 master, 0.1 master, 1 master and 10 master -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://masterpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://masterpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
